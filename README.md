...
* 🛡️ **Raspberry Pi Zero Case kit** for protection and concealment (case will vary if Pisugar battery is used).
...
13. EJ can only run in one (1) configuration mode. ⚠️ **WARNING** If you do not define a configuration mode or define an incorrect configuration mode, EJ
